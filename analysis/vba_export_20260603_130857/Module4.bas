Sub RAO_wk_cancel()
    ...
    caminho = "C:\Users\RMA704\OneDrive - Maersk Group\2025\Py\DSU 2025\RAO_wk_cancel\RAO_wk_cancel.xlsx"
    ...
    Set wsDestino = ThisWorkbook.Sheets("RAO_wk_cancel")
    ...
    ' Aplicar formatação da linha 2 (formato rápido sem copy/paste pesado)
